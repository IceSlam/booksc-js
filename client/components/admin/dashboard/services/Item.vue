<template>
  <li @click.prevent="viewItem()" class="row services_row">
    ...
    <span class="name col-lg-3">
      {{ $moment(ServicesWrapperListItem.createdAt).formatWithJDF("HH:mm dd.MM.yyyy") }}
    </span>
  </li>
</template>
...
export default {
  ...
  methods: {
    viewItem (id) {
      this.$emit('viewItem', this.ServicesWrapperListItem.id)
    }
  }
}
</script>
